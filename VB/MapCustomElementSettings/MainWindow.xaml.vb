...
'INSTANT VB NOTE: The field disasters was renamed since Visual Basic does not allow fields to have the same name as other class members:
		Private disasters_Conflict As List(Of Disaster)
		Public ReadOnly Property Disasters() As List(Of Disaster)
			Get
				Return disasters_Conflict
			End Get
		End Property
		...
		Private Sub Window_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
			disasters_Conflict = DeserializeXml(filepath)
			Me.DataContext = Me
		End Sub
